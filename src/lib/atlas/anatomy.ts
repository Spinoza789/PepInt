...
export interface SceneState {inspectorOpen?:boolean;explode:number;visible:SystemId[];selected:string[];isolate:boolean;view:View;rotate:boolean;reset:number;layerMode?:'normal'|'transparent'|'cutaway'|'focus';shellOpacity?:number;effectLevel?:number;pathwayPlaying?:boolean}
